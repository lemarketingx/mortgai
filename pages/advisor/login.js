        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8">
            <div className="mb-6">
              ...
              <p className="text-slate-500 text-sm">ברוכים הבאים חזרה ל־FINZO PRO.</p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full border border-slate-200 rounded-2xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-violet-400 bg-white pl-14"
                    required
                  />
                  <button
                    type="button"
