      ...
      <main dir="rtl" className="min-h-screen bg-slate-50 dark:bg-slate-950 pb-24 md:pb-0">
        ...
        <div className="max-w-2xl mx-auto px-4 py-6 space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            {savedFlash && <span className="text-xs font-black text-emerald-600 dark:text-emerald-400">נשמר ✓</span>}
          </div>

          {/* Privacy notice */}
          <div className="flex items-start gap-3 bg-sky-50 dark:bg-sky-900/20 border border-sky-200 dark:border-sky-800 rounded-xl px-4 py-3">
