        ...
        <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
          ...
          <div className="mt-8 space-y-8 text-slate-700 leading-relaxed">
            ...
            <section>
              ...
              <p>
                המידע שמסרתם עשוי להיות מועבר ליועצי משכנתאות עצמאיים הרשומים בפלטפורמת FINZO PRO.
                יועצים אלו פועלים באופן עצמאי ואינם עובדי החברה. אין אנו מוכרים את המידע שלכם לגורמים שלישיים למטרות שיווק.
              </p>
            </section>
