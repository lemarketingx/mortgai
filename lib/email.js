...
<body style="font-family:Arial,sans-serif;background:#f1f5f9;margin:0;padding:24px;">
  <div style="max-width:540px;margin:0 auto;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
    ...
    <div style="padding:14px 28px;background:#f8fafc;text-align:center;font-size:11px;color:#94a3b8;border-top:1px solid #e2e8f0;">
      <div style="margin-bottom:4px;">FINZO — מערכת לידים לייעוץ משכנתאות</div>
      <div style="font-size:10px;color:#cbd5e1;">מופעל על ידי <strong style="color:#94a3b8;">ל.א.ה דיגיטל</strong> &nbsp;·&nbsp; הופכים דיגיטל לתוצאות</div>
    </div>
  </div>
</body>
</html>`;
