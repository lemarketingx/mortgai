...
export const HOME_SEO = {
  title: "MortgAI - בדיקת זכאות למשכנתא | אומדן החזר חודשי ובדיקה ראשונית",
  description:
    "בדקו תוך דקה אומדן ראשוני לכמה משכנתא תוכלו לבקש, מה ההחזר החודשי המשוער ומה תמונת הסיכון לפי הכנסה, הון עצמי, יחס החזר ואחוז מימון.",
  path: "/",
  keywords:
