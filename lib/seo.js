...
export const SITE_NAME = "Finzo";
export const OG_IMAGE_URL = `${(process.env.NEXT_PUBLIC_SITE_URL || "https://mortgai-gxjc.vercel.app").replace(/\/$/, "")}/og-image.png`;

export const HOME_SEO = {
  title: "Finzo | בדיקת זכאות חכמה למשכנתא",
  description:
    "בדקו זכאות ראשונית למשכנתא בישראל עם Finzo — אומדן חכם לפי הכנסה, הון עצמי, יחס החזר ונתונים פיננסיים. ללא התחייבות.",
  path: "/",
  keywords:
