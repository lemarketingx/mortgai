import { z } from "zod";
import { COMMISSION_STATUSES, FOLLOW_UP_STAGES, LEAD_PRIORITIES, LEAD_QUALITIES, LEAD_STATUSES, PIPELINE_STAGES, PIPELINE_EXIT_STATUSES } from "./leadsStore";
...
const leadChangesSchema = z.object({
  ...
  pipelineStage: z.string().refine((v) => [...PIPELINE_STAGES, ...PIPELINE_EXIT_STATUSES].includes(v), { message: "INVALID_PIPELINE_STAGE" }).optional(),
