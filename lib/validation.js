...
export const publicLeadSchema = z.object({
  lead: z.object({
    ...
    estimatedApprovalResult: optionalText(120, "ESTIMATED_APPROVAL_RESULT"),
    estimatedPayment: optionalText(60, "ESTIMATED_PAYMENT"),
    propertyPrice: z.union([z.string(), z.number(), z.undefined()]).optional(),
    equityAmount: z.union([z.string(), z.number(), z.undefined()]).optional(),
    monthlyIncome: z.union([z.string(), z.number(), z.undefined()]).optional(),
    debtLevel: optionalText(120, "DEBT_LEVEL"),
  }).passthrough(),
