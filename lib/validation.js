...
const israeliPhoneSchema = z.string()
  ...
  .refine((value) => /^05\d{8}$|^9725\d{8}$/.test(value), {
...
const consentBool = z.preprocess((value) => {
...
export const publicLeadSchema = z.object({
  lead: z.object({
    ...
    consentAdvisorContact: consentBool,
    consent_advisor_contact: consentBool.optional(),
  }).passthrough(),
